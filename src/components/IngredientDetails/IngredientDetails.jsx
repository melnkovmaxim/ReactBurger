...
const IngredientDetails = () => {
    ...
    return (
        <div className={`mb-15 ${componentStyles.content}`}>
            <img className={componentStyles.ingredientImage} src={viewedIngredient.image_large} alt={viewedIngredient.name} />
            <p className={`mt-4 text text_type_main-medium ${componentStyles.textCenter}`}>{viewedIngredient.name}</p>
